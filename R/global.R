...
resident_nav_blocks <- list(
  ...
  list(id = "peer_review",  label = "Peer Review",            icon = "people-fill",             desc = "Give feedback to a fellow resident"),
  ...
  list(id = "duty_hours",   label = "Duty Hours",             icon = "clock-history",           desc = "Estimated hours from your schedule (preview)"),
...
resident_nav_blocks_roundsui <- list(
  ...
  list(id = "peer_review",  label = "Peer Review",            icon = "users",           desc = "Give feedback to a fellow resident"),
  ...
  list(id = "duty_hours",   label = "Duty Hours",             icon = "clock",           desc = "Estimated hours from your schedule (preview)"),
